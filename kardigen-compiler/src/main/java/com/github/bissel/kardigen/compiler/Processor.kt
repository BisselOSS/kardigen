...
class Processor : AbstractProcessor() {
    ...
    override fun getSupportedAnnotationTypes() = mutableSetOf(KodeinInject::class.java.name)

    override fun getSupportedSourceVersion(): SourceVersion = SourceVersion.latest()

    override fun process(set: MutableSet<out TypeElement>, environment: RoundEnvironment): Boolean {
        processingEnv.messager.printMessage(Diagnostic.Kind.WARNING, "Starting kardigen compiler")
